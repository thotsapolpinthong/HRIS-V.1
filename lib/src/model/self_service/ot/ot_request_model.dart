...
OtRequestModel otRequestModelFromJson(String str) =>
    OtRequestModel.fromJson(json.decode(str));

String otRequestModelToJson(OtRequestModel data) => json.encode(data.toJson());
...
class OtRequestModel {
  ...
  factory OtRequestModel.fromJson(Map<String, dynamic> json) => OtRequestModel(
