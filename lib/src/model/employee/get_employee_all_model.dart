...
GetEmployeeAllDataModel getEmployeeAllDataModelFromJson(String str) => GetEmployeeAllDataModel.fromJson(json.decode(str));

String getEmployeeAllDataModelToJson(GetEmployeeAllDataModel data) => json.encode(data.toJson());
...
class GetEmployeeAllDataModel {
    ...
    factory GetEmployeeAllDataModel.fromJson(Map<String, dynamic> json) => GetEmployeeAllDataModel(
        employeeData: List<EmployeeDatum>.from(json["employeeData"].map((x) => EmployeeDatum.fromJson(x))),
...
class EmployeeDatumPositionData {
    ...
    factory EmployeeDatumPositionData.fromJson(Map<String, dynamic> json) => EmployeeDatumPositionData(
        positionOrganizationId: json["positionOrganizationId"],
        positionData: ParentPositionBusinessNodeIdPositionData.fromJson(json["positionData"]),
        ...
        status: json["status"],
        parentPositionBusinessNodeId: ParentPositionNodeId.fromJson(json["parentPositionBusinessNodeId"]),
        parentPositionNodeId: ParentPositionNodeId.fromJson(json["parentPositionNodeId"]),
...
class OrganizationData {
    ...
    factory OrganizationData.fromJson(Map<String, dynamic> json) => OrganizationData(
        ...
        departMentData: DepartmentData.fromJson(json["departMentData"]),
        parentOrganizationNodeData: ParentOrganizationNodeData.fromJson(json["parentOrganizationNodeData"]),
        parentOrganizationBusinessNodeData: ParentOrganizationNodeData.fromJson(json["parentOrganizationBusinessNodeData"]),
        organizationTypeData: OrganizationTypeData.fromJson(json["organizationTypeData"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "parentOrganizationBusinessNodeData": parentOrganizationBusinessNodeData.toJson(),
...
class OrganizationTypeData {
    ...
    factory OrganizationTypeData.fromJson(Map<String, dynamic> json) => OrganizationTypeData(
...
class ParentOrganizationNodeData {
    ...
    factory ParentOrganizationNodeData.fromJson(Map<String, dynamic> json) => ParentOrganizationNodeData(
        organizationId: json["organizationId"],
        organizationCode: json["organizationCode"],
...
class ParentPositionNodeId {
    ...
    factory ParentPositionNodeId.fromJson(Map<String, dynamic> json) => ParentPositionNodeId(
        positionOrganizationId: json["positionOrganizationId"],
        positionData: ParentPositionBusinessNodeIdPositionData.fromJson(json["positionData"]),
    );
...
class ParentPositionBusinessNodeIdPositionData {
    ...
    factory ParentPositionBusinessNodeIdPositionData.fromJson(Map<String, dynamic> json) => ParentPositionBusinessNodeIdPositionData(
...
class PositionTypeData {
    ...
    factory PositionTypeData.fromJson(Map<String, dynamic> json) => PositionTypeData(
...
class StaffStatusData {
    ...
    factory StaffStatusData.fromJson(Map<String, dynamic> json) => StaffStatusData(
