...
ResponseEmployeeModel responseEmployeeModelFromJson(String str) =>
    ResponseEmployeeModel.fromJson(json.decode(str));

String responseEmployeeModelToJson(ResponseEmployeeModel data) =>
    json.encode(data.toJson());

class ResponseEmployeeModel {
  ResponseEmployeeModelEmployeeData employeeData;
  String message;
  bool status;
  ...
  factory ResponseEmployeeModel.fromJson(Map<String, dynamic> json) =>
      ResponseEmployeeModel(
        employeeData:
            ResponseEmployeeModelEmployeeData.fromJson(json["employeeData"]),
...
class ResponseEmployeeModelEmployeeData {
  String employeeId;
  ...
  ResponseEmployeeModelEmployeeData({
  ...
  factory ResponseEmployeeModelEmployeeData.fromJson(
...
class EmployeeDataPositionData {
  ...
  PositionDataEmployeeData employeeData;
  ...
  factory EmployeeDataPositionData.fromJson(Map<String, dynamic> json) =>
      EmployeeDataPositionData(
        ...
        employeeData: PositionDataEmployeeData.fromJson(json["employeeData"]),
...
class PositionDataEmployeeData {
  String employeeId;
  ...
  factory PositionDataEmployeeData.fromJson(Map<String, dynamic> json) =>
      PositionDataEmployeeData(
        employeeId: json["employeeId"],
