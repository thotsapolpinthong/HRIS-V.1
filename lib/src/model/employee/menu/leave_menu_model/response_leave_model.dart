...
ResponseLeaveModel responseLeaveModelFromJson(String str) =>
    ResponseLeaveModel.fromJson(json.decode(str));

String responseLeaveModelToJson(ResponseLeaveModel data) =>
    json.encode(data.toJson());

class ResponseLeaveModel {
  ...
  factory ResponseLeaveModel.fromJson(Map<String, dynamic> json) =>
      ResponseLeaveModel(
