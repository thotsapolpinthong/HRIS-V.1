...
GetLeaveRequestByIdModel getLeaveRequestByIdModelFromJson(String str) =>
    GetLeaveRequestByIdModel.fromJson(json.decode(str));

String getLeaveRequestByIdModelToJson(GetLeaveRequestByIdModel data) =>
    json.encode(data.toJson());

class GetLeaveRequestByIdModel {
  LeaveRequestData leaveRequestData;
  String message;
  bool status;

  GetLeaveRequestByIdModel({
    required this.leaveRequestData,
    required this.message,
    required this.status,
  });

  factory GetLeaveRequestByIdModel.fromJson(Map<String, dynamic> json) =>
      GetLeaveRequestByIdModel(
