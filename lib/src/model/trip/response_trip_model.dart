...
ResponseCreateTripModel responseCreateTripModelFromJson(String str) =>
    ResponseCreateTripModel.fromJson(json.decode(str));

String responseCreateTripModelToJson(ResponseCreateTripModel data) =>
    json.encode(data.toJson());

class ResponseCreateTripModel {
  TripData tripData;
  String message;
  bool status;

  ResponseCreateTripModel({
    required this.tripData,
    required this.message,
    required this.status,
  });

  factory ResponseCreateTripModel.fromJson(Map<String, dynamic> json) =>
      ResponseCreateTripModel(
