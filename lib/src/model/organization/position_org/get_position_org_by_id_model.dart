...
GetPositionOrgByIdModel getPositionOrgByIdModelFromJson(String str) =>
    GetPositionOrgByIdModel.fromJson(json.decode(str));

String getPositionOrgByIdModelToJson(GetPositionOrgByIdModel data) =>
    json.encode(data.toJson());

class GetPositionOrgByIdModel {
  PositionOrganizationData positionOrganizationData;
  String message;
  bool status;

  GetPositionOrgByIdModel({
    required this.positionOrganizationData,
    required this.message,
    required this.status,
  });

  factory GetPositionOrgByIdModel.fromJson(Map<String, dynamic> json) =>
      GetPositionOrgByIdModel(
