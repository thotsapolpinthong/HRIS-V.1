...
class DatatableEmployee extends StatefulWidget {
  ...
  const DatatableEmployee({super.key, required this.isSelected});
                              ...
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: PaginatedDataTable(
                                    ...
                                    source: PersonDataTableSource(employeeData,
                                        context, fetchData, widget.isSelected
                                        // deleteData,
                                        ),
                                  ),
                                ),
...
class PersonDataTableSource extends DataTableSource {
  ...
  DataRow getRow(int index) {
    ...
    return DataRow(
        ...
        onSelectChanged: isSelected == false
            ? null
            : (isSelected) {
